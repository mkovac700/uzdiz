...
public class RegexProvjeraSingleton {
  ...
  private final String regexKomanda =
      "(Q)|((IP)(?: P)?)|(VR (?:[1-9]|1\\d|2[0-4]))|(PP)|((PO) ('[a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9\\s._-]+') ([a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9_-]+) ([D|N]))|((PS) ([a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9_-]+) (A|NI|NA))|(SV)|((VV) ([a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9_-]+))|((VS) ([a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9_-]+) (\\d+))|((SPV) ('[a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9\\s._-]+'))|((PPV) ('[a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9\\s._-]+'))";

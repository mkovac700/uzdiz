...
public class RegexProvjeraSingleton {
  ...
  private final String regexKomanda =
      "(Q)|(IP)|(VR (?:[1-9]|1\\d|2[0-4]))|(PP)|((PO) ('[a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9_-]+ [a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9_-]+') ([a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9_-]+) ([D|N]))|((PS) ([a-zA-ZÀ-ÖØ-öø-ÿČčĆćŽžĐđŠš0-9_-]+) (A|NI|NA))";
